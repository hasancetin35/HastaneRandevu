            ...
            <asp:CreateUserWizardStep ID="RegisterUserWizardStep" runat="server">
                <ContentTemplate>
                    <table>
                        ...
                        <tr>
                            <td align="right">
                                <asp:Label ID="AnswerLabel" runat="server" AssociatedControlID="Answer">Güvenlik Cevap:</asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                <asp:CompareValidator ID="PasswordCompare" runat="server" 
                                    ...
                                    Display="Dynamic" ErrorMessage="şifre ve şifrenin tekrarı aynı olmalıdır." 
                        ...
                        <tr align="right">
                            <td align="right" colspan="0">
                                <asp:Button ID="StepNextButton" runat="server" CommandName="MoveNext" 
                                    Text="Yeni Kullanıcı" ValidationGroup="RegisterUser" />
                            </td>
                        </tr>
                    </table>
                </CustomNavigationTemplate>
