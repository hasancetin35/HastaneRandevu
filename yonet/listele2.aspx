<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="listele2.aspx.cs" Inherits="listele" %>
        ...
        <tr>
            <td class="style2">
                ...
                <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                    DataFile="~/App_Data/veri.mdb" SelectCommand="SELECT * FROM [tablo2]">
