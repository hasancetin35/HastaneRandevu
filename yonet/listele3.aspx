<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="listele3.aspx.cs" Inherits="listele" %>
        ...
        <tr>
            <td class="style2">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    onselectedindexchanged="GridView1_SelectedIndexChanged" Width="911px" 
                ...
                <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                    DataFile="~/App_Data/veri.mdb" SelectCommand="SELECT * FROM [tablo3]">
